  ...
  return (
    <>
      ...
      <a
        ...
        className={`fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-2xl bg-[#25D366] px-5 py-3 text-white shadow-xl transition-all duration-300 hover:opacity-90 ${
      ...
      <div className="relative w-full h-145 sm:h-170 overflow-hidden rounded-3xl shadow-lg">
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-6 sm:p-10">
          ...
          <div className="flex justify-start">
            <div className="flex items-center justify-between gap-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl px-8 py-4 min-w-170">
          ...
          <div className="flex flex-col gap-4 mt-auto">
            ...
            <div className="flex justify-end">
              <button onClick={() => document.getElementById("categories")?.scrollIntoView({ behavior: "smooth", block: "center" })} className="group flex items-center gap-6 bg-orange-800 hover:bg-orange-700 transition-colors rounded-2xl px-8 py-4 min-w-72">
